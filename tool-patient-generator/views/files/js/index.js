...
{
    window.location = 'http://localhost:7001/download/patients'
}

function downloadMessages()
{
    window.location = 'http://localhost:7001/download/messages?type='+$('#typeEvent').val();
}

function downloadClinicians()
{
    window.location = 'http://localhost:7001/download/clinicians'
}
...
function wsConnect() {
    websocket = new WebSocket("ws://localhost:7001");
